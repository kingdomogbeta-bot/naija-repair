...
const DEFAULT_SERVICES = [
  ...
  { id: 6, name: 'Moving & Delivery', description: 'Reliable moving and delivery services with careful handling of your belongings.', image: 'https://images.unsplash.com/photo-1600518464441-9154a4dea21b?w=800&h=600&fit=crop', features: ['Local Moving', 'Packing Services', 'Furniture Delivery', 'Heavy Lifting'], startingPrice: '₦1,500', category: 'Moving', specialService: 'delivery', active: true },
