  ...
  return (
    <>
      <button
        ...
        className="px-3 sm:px-4 py-2 bg-yellow-50 text-yellow-600 rounded-lg text-xs sm:text-sm font-medium hover:bg-yellow-100 flex items-center gap-2"
      >
      ...
      {showTipModal && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4 overflow-y-auto" style={{ zIndex: 999999, position: 'fixed' }}>
          <div className="bg-white rounded-2xl max-w-md w-full p-6 my-8 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-6">
              <div className="flex justify-between mb-2">
                ...
                <span className="font-semibold">₦{(booking.basePrice || booking.totalPrice)?.toLocaleString()}</span>
              </div>
              <div className="flex justify-between mb-2">
              ...
              <div className="flex justify-between pt-2 border-t text-lg font-bold">
                ...
                <span className="text-teal-600">
                  ₦{((booking.basePrice || booking.totalPrice || 0) + (customTip ? parseInt(customTip) : tipAmount)).toLocaleString()}
                </span>
              </div>
            </div>
