            ...
            <>
              <div className="space-y-4 mb-6">
                <button 
                  ...
                  className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 rounded-xl py-3 font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all disabled:opacity-60"
                >
                  {googleLoading ? (
                  ...
                  {googleLoading ? 'Sending OTP...' : 'Sign up with Google'}
                </button>
                <button 
                  onClick={() => {
                    alert('Apple OAuth is not implemented yet. Please use the form below to create your account.');
                  }}
