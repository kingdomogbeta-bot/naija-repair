        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 border-2 border-red-200 rounded-lg bg-red-50">
              <div className="mb-3">
                <p className="font-medium text-red-900">Reset Tasker Data</p>
                <p className="text-sm text-red-700">Clear cached tasker data and reload with updated information</p>
              </div>
              <button
                onClick={() => {
                  if (confirm('This will reset all tasker data. Continue?')) {
                    localStorage.removeItem('naija_taskers');
