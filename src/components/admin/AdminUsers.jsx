...
export default function AdminUsers() {
  ...
  const users = Object.entries(registeredUsers).map(([email, userData], index) => {
    const userBookings = bookings.filter(b => b.createdByEmail === email);
    return {
      id: index + 1,
      ...
      status: 'Active',
      joined: userData.joinedDate || new Date().toISOString().split('T')[0]
    };
  });
