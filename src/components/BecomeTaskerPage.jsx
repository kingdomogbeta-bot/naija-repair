        ...
        <div className="bg-white rounded-2xl shadow-2xl p-4 sm:p-8">
          ...
          {submitted ? (
            ...
            <form
              ...
              onSubmit={e => {
                ...
                const newTasker = {
                  ...
                  completedTasks: 0,
                  hourlyRate: 3000,
                  verified: settings.autoApproveTaskers && !settings.requireIdVerification,
                  approved: settings.autoApproveTaskers,
                ...
                addTasker(newTasker);
                setSubmitted(true);
                auth.login({ name: `${firstName} ${lastName}`.trim(), email, phone: `${countryCode}${phone}`, role: 'tasker' });
            ...
            >
              ...
              <button type="submit" className="w-full bg-teal-600 text-white py-4 rounded-xl font-semibold hover:bg-teal-700 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all">
                Submit Application
              </button>
            </form>
          )}
