...
export default function TaskerProfile() {
  ...
  const reviews = [
    { id: 1, name: 'John Doe', rating: 5, date: '2024-01-15', comment: 'Excellent work! Very professional and completed the job perfectly.', avatar: 'https://ui-avatars.com/api/?name=John+Doe' },
    { id: 2, name: 'Sarah Smith', rating: 5, date: '2024-01-10', comment: 'Highly recommend! Fast, efficient, and great quality.', avatar: 'https://ui-avatars.com/api/?name=Sarah+Smith' },
    { id: 3, name: 'Mike Johnson', rating: 4, date: '2024-01-05', comment: 'Good service, arrived on time and did a solid job.', avatar: 'https://ui-avatars.com/api/?name=Mike+Johnson' },
  ];
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="flex items-start gap-6 mb-8">
                <div className="relative">
                  <img src={tasker.photoUrl} alt={tasker.name} className="w-32 h-32 rounded-2xl object-cover" />
                  {tasker.verified && (
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-500">({tasker.reviewCount} reviews)</span>
                    </div>
              ...
              <div className="border-t pt-6">
                <h2 className="text-xl font-bold text-gray-900 mb-6">Reviews ({tasker.reviewCount})</h2>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
              <div className="text-center mb-6">
                <p className="text-3xl font-bold text-gray-900 mb-1">₦{tasker.hourlyRate.toLocaleString()}</p>
                <p className="text-gray-600">per hour</p>
              </div>
              <button 
                onClick={handleBookNow}
                className="w-full bg-teal-600 text-white py-4 rounded-xl font-semibold hover:bg-teal-700 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all mb-4"
              >
                Book Now
              </button>
              <button 
                onClick={() => user ? setShowMessage(true) : navigate('/login')}
                className="w-full border-2 border-gray-200 text-gray-700 py-3 rounded-xl font-semibold hover:border-teal-500 hover:text-teal-600 transition-all mb-4"
              >
                Send Message
              </button>
              <button
              ...
              >
                ...
                {isTaskerFavorite ? 'Remove from Favorites' : 'Add to Favorites'}
              </button>
              ...
              <div className="mt-6 pt-6 border-t space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600">Joined {new Date(tasker.joinedDate).toLocaleDateString()}</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-green-600 font-medium">{tasker.availability}</span>
                </div>
              </div>
            </div>
          </div>
