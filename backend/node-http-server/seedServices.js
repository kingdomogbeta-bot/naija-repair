...
const DEFAULT_SERVICES = [
  ...
  { name: 'Car Wash & Detailing', description: 'Complete car washing and detailing services to keep your vehicle spotless.', image: 'https://images.unsplash.com/photo-1601362840469-51e4d8d58785?w=800&h=600&fit=crop', features: ['Exterior Wash', 'Interior Cleaning', 'Waxing & Polish', 'Engine Cleaning'], startingPrice: '₦1,800', category: 'Outdoor', active: true },
  { name: 'Catering Services', description: 'Professional catering for events, parties, and special occasions.', image: 'https://images.unsplash.com/photo-1555244162-803834f70033?w=800&h=600&fit=crop', features: ['Event Catering', 'Party Planning', 'Custom Menus', 'Professional Staff'], startingPrice: '₦8,000', category: 'Home', active: true },
  { name: 'Security Services', description: 'Reliable security guards and surveillance systems for homes and businesses.', image: 'https://images.unsplash.com/photo-1557597774-9d273605dfa9?w=800&h=600&fit=crop', features: ['Security Guards', 'CCTV Installation', 'Alarm Systems', '24/7 Monitoring'], startingPrice: '₦5,000', category: 'Home', active: true }
];
...
async function seedServices() {
  try {
    ...
    console.log(`Successfully seeded ${DEFAULT_SERVICES.length} services!`);
