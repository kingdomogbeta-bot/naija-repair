...
const { sendVerificationCode, verifyCode, register, login, googleAuth, getProfile, updateProfile, deleteAccount, getAllUsers, uploadPhoto, deletePhoto, changePassword, getPreferences, updatePreferences } = require('./user.controller');
